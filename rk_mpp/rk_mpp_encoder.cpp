...
MPP_RET test_mpp_enc_cfg_setup(MpiEncMultiCtxInfo *info)
{
    ...
    /* optional */
    {
        ...
        mpp_env_get_u32("sei_mode", (RK_U32 *)&sei_mode, MPP_ENC_SEI_MODE_ONE_FRAME);
        p->sei_mode = sei_mode;
...
MPP_RET test_mpp_run(MpiEncMultiCtxInfo *info)
{
    ...
    while (!p->pkt_eos) {
        ...
        MppFrame frame = NULL;
        MppPacket packet = NULL;
        RK_U8 *buf = (RK_U8 *)mpp_buffer_get_ptr(p->frm_buf);
